...
export default function TweetCard() {
    ...
    const [openReplayModel, setOpenReplayModel] = useState(false)

    function handleCloseReplayModal() {
        setOpenReplayModel(false)
    }

    function handleOpenReplayModel() {
        setOpenReplayModel(true);
    }
    ...
    return (
        <React.Fragment>
            ...
            */}
                ...
                <section>
                    <ReplayModal open={openReplayModel} handleClose={handleCloseReplayModal}/>
                </section>
            </div>
        </React.Fragment>
    );
